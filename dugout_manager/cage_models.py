...
class Pecota_padj_pitchers(Base):
	...
	B1_proj_adj = Column(Numeric)
	B1_proj_adj_sd = Column(Numeric)
	ROE_proj_adj = Column(Numeric)
	ROE_proj_adj_sd = Column(Numeric)
	HBP_proj_adj = Column(Numeric)
	HBP_proj_adj_sd = Column(Numeric)
	BB_proj_adj = Column(Numeric)
	BB_proj_adj_sd = Column(Numeric)
	SO_proj_adj = Column(Numeric)
	SO_proj_adj_sd = Column(Numeric)
	OUT_proj_adj = Column(Numeric)
	GB_proj_adj = Column(Numeric)
	GB_proj_adj_sd = Column(Numeric)
	proj_DRA_minus= Column(Numeric)
	# cFIP= Column(Numeric)
	def __repr__(self):
		return "{}({!r})".format(self.__class__.__name__, self.__dict__)
