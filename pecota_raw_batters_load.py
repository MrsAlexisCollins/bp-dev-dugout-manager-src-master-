...
if vintage_last_judge > vintage_last:
    ...
    for row in pecota_raw:
        ...
        new_entry['draa_pa'] = row.proj_dRAA_PA * 500
        new_entry['hr'] = row.HR_proj_pneu * 500
        new_entry['hr_sd'] = row.HR_proj_pneu_sd
        new_entry['b3'] = row.B3_proj_pneu * 500
        new_entry['b3_sd'] = row.B3_proj_pneu_sd * 500
        new_entry['b2'] = row.B2_proj_pneu * 500
        new_entry['b2_sd'] = row.B2_proj_pneu_sd * 500
        new_entry['b1'] = row.B1_proj_pneu * 500
        new_entry['b1_sd'] = row.B1_proj_pneu_sd * 500
        new_entry['roe'] = row.ROE_proj_pneu * 500
        new_entry['roe_sd'] = row.ROE_proj_pneu_sd * 500
        new_entry['hbp'] = row.HBP_proj_pneu * 500
        new_entry['hbp_sd'] = row.HBP_proj_pneu_sd * 500
        new_entry['bb'] = row.BB_proj_pneu * 500
        new_entry['bb_sd'] = row.BB_proj_pneu_sd * 500
        new_entry['so'] = row.SO_proj_pneu * 500
        new_entry['so_sd'] = row.SO_proj_pneu_sd * 500
        new_entry['gb'] = row.GB_proj_pneu * 500
        new_entry['gb_sd'] = row.GB_proj_pneu_sd * 500
        new_entry['out'] = row.OUT_proj_pneu * 500
